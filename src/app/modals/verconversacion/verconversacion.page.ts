...
@Component({
  selector: 'app-verconversacion',
  templateUrl: './verconversacion.page.html',
  styleUrls: ['./verconversacion.page.scss'],
})
export class VerconversacionPage implements OnInit {
